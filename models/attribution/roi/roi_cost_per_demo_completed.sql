...
WITH campaign_base AS (
    ...
    WHERE date_reached_demo_complete IS NOT null
    ...
    FROM opp_base
    WHERE date_reached_demo_complete >= campaign_member_first_responded_date
    ...
    LEFT JOIN {{ref('demand_gen_costs_fy23')}}
        ...
        AND DATE_TRUNC('month',opp_base.date_reached_demo_complete)=DATE_TRUNC('month',demand_gen_costs_fy23.start_date)
    ...
    SELECT DISTINCT
        ...
        cost AS total_cost,
        COUNT(DISTINCT opportunity_id) AS demo_completed
