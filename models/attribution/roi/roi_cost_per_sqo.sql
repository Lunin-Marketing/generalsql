...
WITH campaign_base AS (
    ...
    FROM opp_base
    WHERE discovery_date >= campaign_member_first_responded_date
    ...
    LEFT JOIN {{ref('demand_gen_costs_fy23')}}
        ...
        AND DATE_TRUNC('month',opp_base.discovery_date)=DATE_TRUNC('month',demand_gen_costs_fy23.start_date)
