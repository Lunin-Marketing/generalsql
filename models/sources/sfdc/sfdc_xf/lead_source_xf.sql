...
FROM {{ source('salesforce', 'lead') }}
    ...
    SELECT
        ...
        CASE 
            ...
            WHEN LOWER(channel_lead_creation_c) = 'social' AND LOWER(medium_lead_creation_c) = 'paid-social' THEN 'Paid Social'
            WHEN LOWER(channel_lead_creation_c) IS null AND LOWER(medium_lead_creation_c) = 'social-paid' THEN 'Organic Social'
            ...
            WHEN LOWER(channel_lead_creation_c) = 'ppc' AND LOWER(medium_lead_creation_c) = 'search' THEN 'Paid Search'
