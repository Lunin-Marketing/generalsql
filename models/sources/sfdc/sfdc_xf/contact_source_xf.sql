...
FROM {{ source('salesforce', 'contact') }}
    ...
    SELECT DISTINCT
        ...
        CASE 
            ...
            WHEN LOWER(channel_lead_creation_c) = 'prospecting' AND LOWER(medium_lead_creation_c) IS null THEN 'Prospecting - General'
        ...
        CASE 
            ...
            WHEN LOWER(channel_lead_creation_c) = 'prospecting' AND LOWER(medium_lead_creation_c) IS null THEN 'Prospecting'
            WHEN LOWER(channel_lead_creation_c) = 'referral' THEN 'Referral'
            WHEN LOWER(channel_lead_creation_c) = 'predates attribution' AND LOWER(medium_lead_creation_c) = 'predates attribution' THEN 'Predates Attribution'
            ELSE 'Other'
