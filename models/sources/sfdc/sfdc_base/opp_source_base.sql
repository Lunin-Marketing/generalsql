...
FROM {{ source('salesforce', 'opportunity') }}
    ...
    SELECT
        ...
        CASE 
            ...
            WHEN LOWER(opp_channel_lead_creation) = 'prospecting' AND LOWER(opp_medium_lead_creation) IS null THEN 'Prospecting - General'
        ...
        CASE 
            ...
            WHEN LOWER(opp_channel_lead_creation) = 'prospecting' AND LOWER(opp_medium_lead_creation) IS null THEN 'Prospecting'
            WHEN LOWER(opp_channel_lead_creation) = 'referral' THEN 'Referral'
            WHEN LOWER(opp_channel_lead_creation) = 'predates attribution' AND LOWER(opp_medium_lead_creation) = 'predates attribution' THEN 'Predates Attribution'
            ELSE 'Other'
